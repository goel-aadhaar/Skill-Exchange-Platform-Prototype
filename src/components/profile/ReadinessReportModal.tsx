      ...
      <div className="space-y-6">
        ...
        <div className="p-6 rounded-2xl bg-white border-2 border-slate-300 space-y-6 print:border-none print:p-0">
          ...
          <div className="pt-4 border-t border-slate-200 flex items-center justify-between text-[11px] text-slate-400">
            <div>Generated by IMT Hyderabad Skill Exchange Platform</div>
        ...
        <div className="flex items-center justify-end gap-2 pt-2 border-t border-slate-100">
          ...
          <button
            type="button"
            onClick={handlePrint}
            className="px-5 py-2 text-xs font-bold text-slate-900 bg-amber-400 hover:bg-amber-500 rounded-lg shadow-sm flex items-center gap-1.5"
          >
